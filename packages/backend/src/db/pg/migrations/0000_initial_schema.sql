...
ALTER TABLE "audit_trail" ADD CONSTRAINT "hbig3rsx1v8v_fkey" FOREIGN KEY ("role_id") REFERENCES "public"."role"("id") ON DELETE no action ON UPDATE no action DEFERRABLE INITIALLY IMMEDIATE;--> statement-breakpoint
...
CREATE INDEX "hbig3rsx1v8v_index" ON "audit_trail" USING btree ("role_id");--> statement-breakpoint
