/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 661753a48a72d502a7f89b706920ac54)
// Runtime types generated with workerd@1.20260128.0 2025-11-09 nodejs_compat
declare namespace Cloudflare {
    ...
    interface ProductionEnv {
        ...
        ALLOWED_ORIGINS: 'http://localhost:5173'
        BASE_URL: 'http://localhost:8080'
        CF_R2_BUCKET: 'hyperion-production'
        CF_TURNSTILE_SITE_VERIFY: 'https://challenges.cloudflare.com/turnstile/v0/siteverify'
        COOKIE_DOMAIN: 'localhost'
        CORS_ALLOW_CREDENTIALS: 1
        CORS_ALLOW_HEADERS: 'Content-Type,User-Agent,X-CAPTCHA-Response,X-CSRF-Token'
