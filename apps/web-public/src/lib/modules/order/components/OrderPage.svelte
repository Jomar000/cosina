...
<div class="min-h-dvh bg-zinc-950 text-zinc-100">
    ...
    <main class="mx-auto max-w-6xl px-4 pb-28 sm:pb-16 sm:px-6">
        ...
        <div
            class="sticky top-11 z-30 -mx-4 border-b border-zinc-800/50 bg-zinc-950/95 px-4 pb-3 pt-1 backdrop-blur-sm sm:-mx-6 sm:px-6"
        >
            <!-- Search Bar -->
            ...
            <!-- Category Filter: 2×2 grid on mobile, scrollable row on sm+ -->
            <div
            ...
            >
                {#each CATEGORIES as cat (cat.value)}
                    ...
                    <button
                        type="button"
                        class={cn(
                            'flex items-center justify-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-medium transition-all sm:shrink-0 sm:rounded-full sm:px-3.5 sm:py-1.5',
