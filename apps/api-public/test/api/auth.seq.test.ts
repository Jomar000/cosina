...
const getDb = () => dbClient(testDatabaseConfig)
        ...
        describe('Sign-in', () => {
            describe('Username', () => {
                ...
                it('Sign-in with multi-role membership should return parsed user roles.', async () => {
                    ...
                    const responseData =
                        (await response.json()) as TApiResponseOk<TSignInResponseData>
            ...
            it('Authenticated session should fail after user is locked.', async () => {
                ...
                try {
                    ...
                    const revokedSessionResponseData =
                        (await revokedSessionResponse.json()) as TApiResponseError
