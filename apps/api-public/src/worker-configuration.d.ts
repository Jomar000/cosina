/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 71f1e83908eea5bf22a634663737be77)
// Runtime types generated with workerd@1.20260515.1 2026-05-07 nodejs_compat
interface __BaseEnv_Env {
    COSINAPUB_KV: KVNamespace
    COSINAPUB_HD: Hyperdrive
    ENVIRONMENT: 'test' | 'staging' | 'production' | 'development'
    STATUS: 'up'
    CF_R2_BUCKET_PRIVATE:
        | 'cosina-test-prv'
        | 'cosina-staging-prv'
        | 'cosina-production-prv'
        | 'cosina-development-prv'
    CF_R2_BUCKET_PUBLIC:
        | 'cosina-test-pub'
        | 'cosina-staging-pub'
        | 'cosina-production-pub'
        | 'cosina-development-pub'
    CF_R2_BUCKET_PUBLIC_URL:
        | 'https://cosina-development-r2.4thdevision.tech'
        | ''
    ...
    CF_TURNSTILE_SITE_VERIFY_TIMEOUT_MS: 5000
    CF_TURNSTILE_TOKEN_MAX_LENGTH: 2048
    COOKIE_DOMAIN: 'localhost'
    CORS_ALLOW_CREDENTIALS: 1
    CORS_ALLOW_HEADERS: 'Content-Type,User-Agent,X-CAPTCHA-Response,X-CSRF-Token'
    CORS_ALLOW_METHODS: 'GET,POST'
    CORS_EXPOSE_HEADERS: 'Content-Length'
    CORS_MAX_AGE: 7200
    MAILER_ACCOUNT: 'no-reply@cosina.app'
    ...
    COSINAPUB_DO_WSS: DurableObjectNamespace<
        import('./core/index').WebSocketServer
    >
    COSINABOFC_DO_WSS: DurableObjectNamespace<
        import('./core/index').WebSocketServer
    >
}
declare namespace Cloudflare {
    ...
    interface TestEnv {
        ...
        ENVIRONMENT: 'test'
        STATUS: 'up'
        CF_R2_BUCKET_PRIVATE: 'cosina-test-prv'
        CF_R2_BUCKET_PUBLIC: 'cosina-test-pub'
        CF_R2_BUCKET_PUBLIC_URL: 'https://cosina-development-r2.4thdevision.tech'
        CF_R2_PRESIGN_EXPIRY: 300
    ...
    interface StagingEnv {
        ...
        ENVIRONMENT: 'staging'
        STATUS: 'up'
        CF_R2_BUCKET_PRIVATE: 'cosina-staging-prv'
        CF_R2_BUCKET_PUBLIC: 'cosina-staging-pub'
        CF_R2_BUCKET_PUBLIC_URL: ''
        CF_R2_PRESIGN_EXPIRY: 300
        CF_TURNSTILE_BYPASS: 1
        CF_TURNSTILE_SITE_VERIFY: 'https://challenges.cloudflare.com/turnstile/v0/siteverify'
    ...
    interface ProductionEnv {
        ...
        STATUS: 'up'
        CF_R2_BUCKET_PRIVATE: 'cosina-production-prv'
        CF_R2_BUCKET_PUBLIC: 'cosina-production-pub'
        CF_R2_BUCKET_PUBLIC_URL: ''
        CF_R2_PRESIGN_EXPIRY: 300
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<
        Pick<
            ...
            | 'CF_TURNSTILE_SITE_VERIFY_TIMEOUT_MS'
            | 'CF_TURNSTILE_TOKEN_MAX_LENGTH'
            | 'COOKIE_DOMAIN'
