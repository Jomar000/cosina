<script lang="ts">
    import * as Alert from '@cosina/ui/components/alert'
    import * as Avatar from '@cosina/ui/components/avatar'
    import { Badge } from '@cosina/ui/components/badge'
    ...
    import { Progress } from '@cosina/ui/components/progress'
    import * as Table from '@cosina/ui/components/table'
