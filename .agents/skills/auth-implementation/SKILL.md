...
4.  **Session Storage:** Primary in Postgres, secondary in Cloudflare KV (`HYPERION{PUB|BOFC}_KV`) via `secondaryStorage`. KV minimum TTL workaround: any TTL < 60s is clamped to 60s.
